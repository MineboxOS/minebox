...
function Notify(data) {
  ...
  settings.templates = {
    outer: '<div id="{{id}}" class="' + settings.class + '"><div class="obfuscation-layer"></div><div class="window"><img src="./assets/images/minebox-logo.svg" class="logo" />{{contents}}<div class="close-btn"></div><div class="buttons clearfix"><button class="accept">{{acceptText}}</button>{{buttons}}</div></div></div>',
